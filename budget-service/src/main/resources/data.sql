...
INSERT INTO orcamento (ordem_servico_id, status_orcamento, valor_total, data_criacao, ativo) VALUES
(1, 'CRIADO', 685.90, CURRENT_TIMESTAMP, true),
...
INSERT INTO item_orcamento (orcamento_id, descricao, quantidade, valor_unitario, valor_total, reserva_estoque_id) VALUES
(1, 'Filtro de Óleo', 1, 35.90, 35.90, 1),
(1, 'Óleo Motor 5W30', 4, 45.00, 180.00, 2);

-- Itens de orçamento (serviços)
INSERT INTO item_orcamento (orcamento_id, descricao, quantidade, valor_unitario, valor_total) VALUES
(1, 'Troca de Óleo', 1, 120.00, 120.00),

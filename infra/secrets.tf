...
locals {
  ...
  jwt_secret        = var.secrets_manager_jwt_secret_name != "" ? data.aws_secretsmanager_secret_version.jwt_secret[0].secret_string : "dev-jwt-secret-key-minimum-256-bits-for-hs256-algorithm-change-me"
